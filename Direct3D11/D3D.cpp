...
int D3D::init( HWND hWnd, INT width, INT height, bool isWindowed )
{
	...
	_pD3DDevice->CreateDepthStencilState( &DSdesc, &_pDepthStencilStateZWriteOff );
	...
	_pD3DDevice->CreateDepthStencilState( &DSdesc, &_pDepthStencilStateDefault );


	_pD3DDeviceContext->OMSetDepthStencilState( _pDepthStencilStateDefault, 0 );
...
void D3D::clearRenderTarget( FLOAT red, FLOAT green, FLOAT blue )
{
...
void D3D::deInit()
{
	...
	safeRelease<ID3D11DepthStencilState>( _pDepthStencilStateZWriteOff );
	safeRelease<ID3D11DepthStencilState>( _pDepthStencilStateDefault );
...
void D3D::disableDrawToDepthStencil()
{
	_pD3DDeviceContext->OMSetDepthStencilState( _pDepthStencilStateZWriteOff, 0 );
